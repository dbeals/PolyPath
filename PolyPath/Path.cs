...
namespace PolyPath
{
	public sealed class Path
	{
		...
		public Vector3? NextWaypoint => _waypoints.Count == 0 ? (Vector3?) null : _waypoints.First();
		public Vector3? LastWaypoint => _waypoints.Count == 0 ? (Vector3?) null : _waypoints.Last();
